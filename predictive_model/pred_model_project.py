...
def main():
    ...
    # >>> ekrandaki isimlere ve yerlere göre varsayılanları koydum
    ...
    parser.add_argument("--sep", default=";", help="CSV ayraç (default: ;)")  # noktalı virgül
    ...
    # çıktı dosyalarını aynı klasöre alalım ki kolay bul
